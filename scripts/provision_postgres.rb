...
def show_postgres96_warning()
  ...
  puts colorize_yellow('**                                                   **')
  puts colorize_yellow('** PostgreSQL 9.6 goes end-of-life in November 2021. **')
  puts colorize_yellow('** Please consider updating your service to use      **')
  puts colorize_yellow('** a more recent version.                            **')
  puts colorize_yellow('**                                                   **')
  puts colorize_yellow('*******************************************************')
end